...
#include "MKL_OneButtonTiny.h"  // This example also works with reduced MKL_OneButtonTiny class saving.
...
MKL_OneButtonTiny button(PIN_INPUT, true);  // This example also works with reduced MKL_OneButtonTiny class saving.
